  ...
  return (
    <>
      <div className="w-[414px] h-[736px] relative overflow-hidden bg-[#9395d3]">
        ...
        <div className="w-[375px] h-[57px]">
          <p className="w-[375px] absolute left-5 top-[441px] text-lg font-bold text-center text-white">
            안녕하세요!
          </p>
          <p className="w-[335px] absolute left-10 top-[466px] text-xs text-center text-white">
            <span className="w-[335px] text-xs text-center text-white">
              매일매일 시간을 기록하고 분석해주는
            </span>
            <br />
            <span className="w-[335px] text-xs text-center text-white">
        ...
        <Icon
          ...
          height={32}
          viewBox="0 0 32 32"
          path="M13.2855 15C13.2855 14.4477 12.8378 14 12.2855 14H11.8241C11.6324 14 11.4448 14.0551 11.2836 14.1587L9.3275 15.4153C9.12339 15.5464 9 15.7724 9 16.015C9 16.5779 9.62201 16.9187 10.0964 16.6156L11.37 15.802C11.3774 15.7973 11.3861 15.7947 11.3949 15.7947C11.4204 15.7947 11.4411 15.8154 11.4411 15.8409V23.2596C11.4411 23.7689 11.8539 24.1818 12.3633 24.1818C12.8726 24.1818 13.2855 23.7689 13.2855 23.2596V15ZM17.3507 23.9482C17.8744 24.1967 18.4676 24.321 19.1305 24.321C19.8497 24.321 20.4828 24.1719 21.0297 23.8736C21.5798 23.572 22.0091 23.1593 22.3173 22.6357C22.6289 22.1087 22.7846 21.5088 22.7846 20.8359C22.7846 20.183 22.6454 19.603 22.367 19.0959C22.0886 18.5888 21.7075 18.1911 21.2236 17.9027C20.7396 17.611 20.1895 17.4652 19.573 17.4652C19.162 17.4652 18.7842 17.5398 18.4395 17.6889C18.1016 17.8318 17.8386 18.0114 17.6504 18.2275C17.6431 18.2359 17.6326 18.2408 17.6215 18.2408C17.599 18.2408 17.5815 18.2212 17.5839 18.1988L17.7758 16.4332C17.8309 15.9257 18.2595 15.5412 18"
        />
        <svg
          width={32}
          height={32}
