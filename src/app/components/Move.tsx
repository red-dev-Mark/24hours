...
export default function Move() {
    return (
      <div className="w-[414px] h-[68px]">
        <div className="w-[414px] h-[68px] absolute left-[-0.5px] top-[667.5px] bg-white" />
        <Link href="/home">
          <div className="w-[207px] h-[68px]">
            <svg
              width={30}
              height={30}
              viewBox="0 0 30 30"
              ...
              className="w-[30px] h-[30px] absolute left-[91px] top-[680px]"
            ...
            <p className="w-[35px] absolute left-[97px] top-[711px] text-[10px] text-left text-[#8b8787]">
              기록
            </p>
          </div>
        </Link>
        ...
        <Link href="/analysis">
          <div>
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="w-[30px] h-[30px] absolute left-[303px] top-[677px]"
              preserveAspectRatio="none"
            >
              <path
            ...
            <p className="w-[49px] absolute left-[309px] top-[707px] text-[10px] text-left text-[#9395d3]">
              분석
            </p>
          </div>
        </Link>
